...
fun AboutScreen(
    ...
    MochiBackground {
        Column(
            ...
            AboutSectionCard(
                title = stringResource(R.string.about_category_informations),
                ...
                Row(modifier = Modifier.padding(bottom = 16.dp)) {
                    Text(
                        text = stringResource(R.string.about_date_label),
                        fontWeight = FontWeight.Bold,
                        modifier = Modifier.padding(end = 16.dp),
                        color = MaterialTheme.colorScheme.onSurface
                    )
                ...
                FullWidthButton(
                    text = stringResource(R.string.about_issue_tracker),
            ...
            // Credits Section
            AboutSectionCard(
                title = stringResource(R.string.about_category_credits),
                // Using info icon as placeholder for ic_menu_info_details if not vector
                icon = Icons.Default.Info 
            ) {
                // Design / Dev
                Text(
                    text = stringResource(R.string.about_design_dev),
                    fontWeight = FontWeight.Bold,
                    color = MaterialTheme.colorScheme.primary,
                ...
                FullWidthButton(
                    text = stringResource(R.string.about_tipeee),
                ...
                // Pedagogical Content
                Text(
                    text = stringResource(R.string.about_pedagogical),
                    fontWeight = FontWeight.Bold,
                    color = MaterialTheme.colorScheme.primary,
                    modifier = Modifier.padding(bottom = 4.dp)
                )
                Text(
                    text = stringResource(R.string.about_coming_soon),
                    fontSize = 16.sp,
                    color = MaterialTheme.colorScheme.onSurface,
                    modifier = Modifier.padding(bottom = 8.dp)
                )
            ...
            // Resources Section
            AboutSectionCard(
                title = stringResource(R.string.about_category_resources),
                // Using default icon as placeholder for ic_menu_gallery
                icon = Icons.Default.Info 
            ) {
                 FullWidthButton(
                    text = stringResource(R.string.about_kanji_data_credit),
